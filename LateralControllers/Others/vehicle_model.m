...
%    B2 — 4×1 disturbance matrix (desired yaw rate from road curvature)
%
%  States : [e1; de1; e2; de2]  (lateral deviation & heading error)
%  Input  : delta (front-wheel steering angle)
%  Disturbance : desired yaw rate (Vx / R)
    ...
    %% Disturbance matrix — desired yaw rate from road curvature (Vx/R)
    B2 = [0; ...
         -(2*lf*Caf - 2*lr*Car)/(m*Vx) - Vx; ...
          0; ...
         -(2*lf^2*Caf + 2*lr^2*Car)/(Iz*Vx)];
