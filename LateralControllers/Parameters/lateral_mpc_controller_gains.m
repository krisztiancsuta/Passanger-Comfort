function lateral_mpc_controller_gains()
...
%  Location: LateralControllers/Parameters/
    ...
    % ===================================================================
    [Kmpc, Ky, H, Phi_Phi, Phi_F, Phi_R, F, Phi, A_e, B_e, C_e, ~, ~, Bd2, ~] = ...
    ...
    exportParam('MPC_PhiPhi',            Phi_Phi, '', ...
        'Quadratic cost matrix Phi''*Q*Phi');
    exportParam('MPC_PhiF',              Phi_F,  '', ...
        'Free-response prediction matrix');
    exportParam('MPC_PhiR',              Phi_R,  '', ...
        'Reference prediction matrix');
    exportParam('MPC_F',                 F,      '', ...
        'Output free evolution matrix over horizon');
    exportParam('MPC_Phi',               Phi,    '', ...
        'Block-Toeplitz control prediction matrix');
