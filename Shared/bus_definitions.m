...
%    addElementToBus(busName, name, dataType, dims, description)
    ...
    %% ---- bus_VehicleStates --------------------------------------------
    elems = [ ...
        createBusElement('positionX',            'double', 1, 'Global X position [m]'), ...
        createBusElement('positionY',            'double', 1, 'Global Y position [m]'), ...
    ...
    %% ---- bus_ReferenceStates ------------------------------------------
    elems = [ ...
        createBusElement('referenceX',         'double', 1, 'Reference X position [m]'), ...
        createBusElement('referenceY',         'double', 1, 'Reference Y position [m]'), ...
        createBusElement('referenceYaw',       'double', 1, 'Reference yaw angle [rad]'), ...
        createBusElement('referenceYawRate',   'double', 1, 'Reference yaw rate [rad/s]'), ...
        createBusElement('referenceCurvature', 'double', 1, 'Reference curvature [1/m]'), ...
